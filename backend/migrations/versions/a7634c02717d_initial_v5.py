...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_oauth_connections_provider_user_id"), "oauth_connections", ["provider_user_id"], unique=False
    )
    op.create_table(
        "refresh_token",
        sa.Column("id", sa.BigInteger(), nullable=False),
    ...
    op.create_index(
        op.f("ix_balancer_tournament_sheet_tournament_id"),
        "tournament_sheet",
        ["tournament_id"],
        unique=False,
        schema="balancer",
    ...
    op.create_index(
        op.f("ix_log_processing_record_tournament_id"), "log_processing_record", ["tournament_id"], unique=False
    )
    op.create_table(
        "team",
        sa.Column("id", sa.BigInteger(), nullable=False),
    ...
    op.create_index(
        op.f("ix_tournament_discord_channel_channel_id"), "tournament_discord_channel", ["channel_id"], unique=True
    )
    op.create_table(
        "tournament_group",
        sa.Column("id", sa.BigInteger(), nullable=False),
    ...
    op.create_index(
        op.f("ix_analytics_predictions_algorithm_id"), "analytics_predictions", ["algorithm_id"], unique=False
    )
    op.create_index(op.f("ix_analytics_predictions_team_id"), "analytics_predictions", ["team_id"], unique=False)
    op.create_index(
        op.f("ix_analytics_predictions_tournament_id"), "analytics_predictions", ["tournament_id"], unique=False
    )
    op.create_table(
        "application",
        sa.Column("id", sa.BigInteger(), nullable=False),
    ...
    op.create_index(
        op.f("ix_balancer_application_battle_tag_normalized"),
        "application",
    ...
    op.create_index(
        op.f("ix_balancer_application_tournament_id"), "application", ["tournament_id"], unique=False, schema="balancer"
    )
    op.create_index(
        op.f("ix_balancer_application_tournament_sheet_id"),
        "application",
        ["tournament_sheet_id"],
        unique=False,
        schema="balancer",
    ...
    op.create_index(
        "ix_encounter_tournament_group", "encounter", ["tournament_id", "tournament_group_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_analytics_tournament_tournament_id"), "analytics_tournament", ["tournament_id"], unique=False
    )
    op.create_table(
        "player",
        sa.Column("id", sa.BigInteger(), nullable=False),
    ...
    op.create_index(
        op.f("ix_balancer_player_application_id"), "player", ["application_id"], unique=False, schema="balancer"
    )
    op.create_index(
        op.f("ix_balancer_player_battle_tag_normalized"),
        "player",
        ["battle_tag_normalized"],
        unique=False,
        schema="balancer",
    ...
    op.create_index(
        op.f("ix_balancer_player_tournament_id"), "player", ["tournament_id"], unique=False, schema="balancer"
    )
    ...
    op.create_index(
        "ix_match_statistics_match_name_round", "match_statistics", ["match_id", "name", "round"], unique=False
    )
    op.create_index(
        "ix_match_statistics_match_user_round", "match_statistics", ["match_id", "user_id", "round"], unique=False
    )
    ...
    op.create_index(
        "ix_match_statistics_user_round_name", "match_statistics", ["user_id", "round", "name"], unique=False
    )
