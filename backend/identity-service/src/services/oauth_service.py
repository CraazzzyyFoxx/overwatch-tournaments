...
class OAuthService:
    ...
    async def _find_existing_auth_user(
        ...
        # 3. Primary lookup: players.user.auth_user_id direct link
        ...
        #    This handles legacy accounts that were created before auth_user_id
        #    was automatically populated on first login.
