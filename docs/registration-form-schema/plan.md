...
def test_disabled_builtins_and_absent_keys_are_omitted_and_empty_config_yields_the_default():
    assert [f["key"] for f in mod.legacy_to_schema({}, [])["sections"][0]["fields"]] == ["battle_tag", "smurf_tags", "identity_discord", "identity_twitch"]
