  ...
  analytics: {
    ...
    glossary: {
      ...
      smurf: {
        ...
        plain: "Играет сильно выше своего дивизиона — возможно, недооценённый аккаунт."
      },
      throw: {
        label: "Возможный слив",
        plain: "Резкое падение игры в середине серии."
      },
      troll: {
        label: "Возможный griefing",
        plain: "Регулярная игра ниже собственного уровня для близкого дивизиона."
      },
      sandbag: {
        label: "Возможный сэндбэг",
        plain: "Внезапный одно-турнирный провал относительно собственной истории."
      }
    }
  }
};
