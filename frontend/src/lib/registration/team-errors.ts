 ...
 *
 * §12.2 of the team-registration design: `friendlyMessage` in `lib/api/error.ts`
 ...
 *
 * Exhaustive on purpose: `lib/registration/team-errors.test.ts` asserts that each one
