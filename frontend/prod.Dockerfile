...
ARG NEXT_PUBLIC_PLATFORM_ZONE
ARG NEXT_PUBLIC_COOKIE_PREFIX
...
ENV NEXT_PUBLIC_PLATFORM_ZONE=${NEXT_PUBLIC_PLATFORM_ZONE}
ENV NEXT_PUBLIC_COOKIE_PREFIX=${NEXT_PUBLIC_COOKIE_PREFIX}
