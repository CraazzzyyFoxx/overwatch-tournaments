...
var UsersAdminRoutes = []edge.RouteSpec{
	...
	// Discord identities
	{Method: "POST", Pattern: "/api/v1/admin/users/{id}/discord", Queue: "rpc.app.users.discord_add", IDParam: "id", Body: true, Auth: edge.AuthRequired},
	{Method: "PATCH", Pattern: "/api/v1/admin/users/{id}/discord/{identity_id}", Queue: "rpc.app.users.discord_update", IDParam: "id", Path: []string{"identity_id"}, Body: true, Auth: edge.AuthRequired},
	{Method: "DELETE", Pattern: "/api/v1/admin/users/{id}/discord/{identity_id}", Queue: "rpc.app.users.discord_delete", IDParam: "id", Path: []string{"identity_id"}, Auth: edge.AuthRequired, Success: 204},
	// BattleTag identities
	{Method: "POST", Pattern: "/api/v1/admin/users/{id}/battle-tag", Queue: "rpc.app.users.battletag_add", IDParam: "id", Body: true, Auth: edge.AuthRequired},
	{Method: "PATCH", Pattern: "/api/v1/admin/users/{id}/battle-tag/{identity_id}", Queue: "rpc.app.users.battletag_update", IDParam: "id", Path: []string{"identity_id"}, Body: true, Auth: edge.AuthRequired},
	{Method: "DELETE", Pattern: "/api/v1/admin/users/{id}/battle-tag/{identity_id}", Queue: "rpc.app.users.battletag_delete", IDParam: "id", Path: []string{"identity_id"}, Auth: edge.AuthRequired, Success: 204},
	// Twitch identities
	{Method: "POST", Pattern: "/api/v1/admin/users/{id}/twitch", Queue: "rpc.app.users.twitch_add", IDParam: "id", Body: true, Auth: edge.AuthRequired},
	{Method: "PATCH", Pattern: "/api/v1/admin/users/{id}/twitch/{identity_id}", Queue: "rpc.app.users.twitch_update", IDParam: "id", Path: []string{"identity_id"}, Body: true, Auth: edge.AuthRequired},
	{Method: "DELETE", Pattern: "/api/v1/admin/users/{id}/twitch/{identity_id}", Queue: "rpc.app.users.twitch_delete", IDParam: "id", Path: []string{"identity_id"}, Auth: edge.AuthRequired, Success: 204},
