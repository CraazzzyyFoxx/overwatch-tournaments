...
// dispatcher is generic. Specific patterns here win over the /api/v1/balancer
...
//
// External paths use the clean /api/v1/balancer/* scheme. The worker's RPC queues
// are path-independent, so the legacy doubled /api/v1/balancer/balancer/* (FastAPI
...
var PublicRoutes = []edge.RouteSpec{
	{Method: "GET", Pattern: "/api/v1/balancer/config", Queue: "rpc.balancer.config", Auth: edge.AuthNone, Timeout: fastReadTimeout},
}
...
var AdminRoutes = []edge.RouteSpec{
	{Method: "GET", Pattern: "/api/v1/balancer/tournaments/{tournament_id}/config", Queue: "rpc.balancer.admin.tournament_config_get", IDParam: "tournament_id", Auth: edge.AuthRequired, Timeout: fastReadTimeout},
	{Method: "PUT", Pattern: "/api/v1/balancer/tournaments/{tournament_id}/config", Queue: "rpc.balancer.admin.tournament_config_upsert", IDParam: "tournament_id", Body: true, Auth: edge.AuthRequired},
	{Method: "GET", Pattern: "/api/v1/balancer/tournaments/{tournament_id}/summary", Queue: "rpc.balancer.admin.tournament_summary_get", IDParam: "tournament_id", Auth: edge.AuthRequired, Timeout: fastReadTimeout},
	{Method: "GET", Pattern: "/api/v1/balancer/tournaments/{tournament_id}/balance", Queue: "rpc.balancer.admin.balance_get", IDParam: "tournament_id", Auth: edge.AuthRequired},
	{Method: "PUT", Pattern: "/api/v1/balancer/tournaments/{tournament_id}/balance", Queue: "rpc.balancer.admin.balance_save", IDParam: "tournament_id", Body: true, Auth: edge.AuthRequired},
	{Method: "POST", Pattern: "/api/v1/balancer/balances/{balance_id}/export", Queue: "rpc.balancer.admin.balance_export", IDParam: "balance_id", Auth: edge.AuthRequired},
	...
	{Method: "POST", Pattern: "/api/v1/balancer/balances/{balance_id}/export-ranks", Queue: "rpc.balancer.admin.balance_ranks_export", IDParam: "balance_id", Auth: edge.AuthRequired},
...
var RosterRoutes = []edge.RouteSpec{
	{Method: "GET", Pattern: "/api/v1/balancer/workspaces/{workspace_id}/players", Queue: "rpc.balancer.players.list", Path: []string{"workspace_id"}, AllQuery: true, Auth: edge.AuthRequired, Timeout: fastReadTimeout},
	{Method: "GET", Pattern: "/api/v1/balancer/workspaces/{workspace_id}/players/summary", Queue: "rpc.balancer.players.summary", Path: []string{"workspace_id"}, AllQuery: true, Auth: edge.AuthRequired, Timeout: fastReadTimeout},
	{Method: "POST", Pattern: "/api/v1/balancer/workspaces/{workspace_id}/players", Queue: "rpc.balancer.players.upsert", Path: []string{"workspace_id"}, Body: true, Auth: edge.AuthRequired},
	...
	{Method: "GET", Pattern: "/api/v1/balancer/workspaces/{workspace_id}/custom-games", Queue: "rpc.balancer.custom.list", Path: []string{"workspace_id"}, Auth: edge.AuthNone, Timeout: fastReadTimeout},
	{Method: "POST", Pattern: "/api/v1/balancer/workspaces/{workspace_id}/custom-games", Queue: "rpc.balancer.custom.create", Path: []string{"workspace_id"}, Body: true, Auth: edge.AuthRequired},
	...
	{Method: "PUT", Pattern: "/api/v1/balancer/workspaces/{workspace_id}/custom-games/{game_id}/players", Queue: "rpc.balancer.custom.set_participation", IDParam: "game_id", Path: []string{"workspace_id"}, Body: true, Auth: edge.AuthRequired},
	{Method: "PUT", Pattern: "/api/v1/balancer/workspaces/{workspace_id}/custom-games/{game_id}/team-names", Queue: "rpc.balancer.custom.set_team_names", IDParam: "game_id", Path: []string{"workspace_id"}, Body: true, Auth: edge.AuthRequired},
	{Method: "PUT", Pattern: "/api/v1/balancer/workspaces/{workspace_id}/custom-games/{game_id}/next-map", Queue: "rpc.balancer.custom.set_next_map", IDParam: "game_id", Path: []string{"workspace_id"}, Body: true, Auth: edge.AuthRequired},
	...
	{Method: "GET", Pattern: "/api/v1/balancer/me/mix-preferences", Queue: "rpc.balancer.prefs.get", Auth: edge.AuthRequired, Timeout: fastReadTimeout},
	{Method: "PUT", Pattern: "/api/v1/balancer/me/mix-preferences", Queue: "rpc.balancer.prefs.upsert", Body: true, Auth: edge.AuthRequired},
}
...
var JobRoutes = []edge.RouteSpec{
	{Method: "GET", Pattern: "/api/v1/balancer/jobs/{job_id}", Queue: "rpc.balancer.jobs.status", IDParam: "job_id", Auth: edge.AuthRequired, Timeout: fastReadTimeout},
	{Method: "GET", Pattern: "/api/v1/balancer/jobs/{job_id}/result", Queue: "rpc.balancer.jobs.result", IDParam: "job_id", Auth: edge.AuthRequired},
	{Method: "POST", Pattern: "/api/v1/balancer/tournaments/{tournament_id}/balance", Queue: "rpc.balancer.jobs.create_for_tournament", IDParam: "tournament_id", Body: true, Auth: edge.AuthRequired, Success: 202},
	...
	{Method: "POST", Pattern: "/api/v1/balancer/balance", Queue: "rpc.balancer.balance", Query: []string{"workspace_id"}, Body: true, Auth: edge.AuthRequired, Timeout: syncBalanceTimeout},
}
...
var DraftReadRoutes = []edge.RouteSpec{
	{Method: "GET", Pattern: "/api/v1/balancer/draft/tournaments/{tournament_id}/draft", Queue: "rpc.balancer.draft.tournament_board", IDParam: "tournament_id", Auth: edge.AuthNone, Timeout: fastReadTimeout},
	{Method: "GET", Pattern: "/api/v1/balancer/draft/sessions/{session_id}", Queue: "rpc.balancer.draft.session_get", IDParam: "session_id", Auth: edge.AuthNone, Timeout: fastReadTimeout},
	{Method: "GET", Pattern: "/api/v1/balancer/draft/sessions/{session_id}/board", Queue: "rpc.balancer.draft.session_board", IDParam: "session_id", Auth: edge.AuthNone, Timeout: fastReadTimeout},
}
...
var DraftRoutes = []edge.RouteSpec{
	...
	{Method: "POST", Pattern: "/api/v1/balancer/draft/tournaments/{tournament_id}/sessions", Queue: "rpc.balancer.draft.session_create", IDParam: "tournament_id", Body: true, Auth: edge.AuthRequired},
	{Method: "DELETE", Pattern: "/api/v1/balancer/draft/tournaments/{tournament_id}/sessions/{session_id}", Queue: "rpc.balancer.draft.session_delete", IDParam: "session_id", Path: []string{"tournament_id"}, Auth: edge.AuthRequired, Success: 204},
	{Method: "POST", Pattern: "/api/v1/balancer/draft/tournaments/{tournament_id}/sessions/{session_id}/seed", Queue: "rpc.balancer.draft.seed", IDParam: "session_id", Path: []string{"tournament_id"}, Body: true, Auth: edge.AuthRequired},
	{Method: "PATCH", Pattern: "/api/v1/balancer/draft/tournaments/{tournament_id}/sessions/{session_id}", Queue: "rpc.balancer.draft.session_patch", IDParam: "session_id", Path: []string{"tournament_id"}, Body: true, Auth: edge.AuthRequired},
	{Method: "POST", Pattern: "/api/v1/balancer/draft/tournaments/{tournament_id}/sessions/{session_id}/start", Queue: "rpc.balancer.draft.start", IDParam: "session_id", Path: []string{"tournament_id"}, Auth: edge.AuthRequired},
	{Method: "POST", Pattern: "/api/v1/balancer/draft/tournaments/{tournament_id}/sessions/{session_id}/pause", Queue: "rpc.balancer.draft.pause", IDParam: "session_id", Path: []string{"tournament_id"}, Auth: edge.AuthRequired},
	{Method: "POST", Pattern: "/api/v1/balancer/draft/tournaments/{tournament_id}/sessions/{session_id}/resume", Queue: "rpc.balancer.draft.resume", IDParam: "session_id", Path: []string{"tournament_id"}, Auth: edge.AuthRequired},
	{Method: "POST", Pattern: "/api/v1/balancer/draft/tournaments/{tournament_id}/sessions/{session_id}/cancel", Queue: "rpc.balancer.draft.cancel", IDParam: "session_id", Path: []string{"tournament_id"}, Auth: edge.AuthRequired},
	{Method: "POST", Pattern: "/api/v1/balancer/draft/tournaments/{tournament_id}/sessions/{session_id}/rollback", Queue: "rpc.balancer.draft.rollback", IDParam: "session_id", Path: []string{"tournament_id"}, Auth: edge.AuthRequired},
	{Method: "POST", Pattern: "/api/v1/balancer/draft/tournaments/{tournament_id}/sessions/{session_id}/export", Queue: "rpc.balancer.draft.export", IDParam: "session_id", Path: []string{"tournament_id"}, Auth: edge.AuthRequired},
	// Rank-only re-export: leaves the exported teams in place, refreshes their ranks.
	{Method: "POST", Pattern: "/api/v1/balancer/draft/tournaments/{tournament_id}/sessions/{session_id}/export-ranks", Queue: "rpc.balancer.draft.export_ranks", IDParam: "session_id", Path: []string{"tournament_id"}, Auth: edge.AuthRequired},
	// pick actions
