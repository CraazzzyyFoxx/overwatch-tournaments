...
// registrations in cmd/gateway/main.go.
...
var BinaryPublicDocRoutes = []edge.RouteSpec{
	{Method: "POST", Pattern: "/api/balancer/jobs", Auth: edge.AuthRequired}, // multipart: create balance job
}

// BinaryAdminDocRoutes is the admin teams-import upload.
var BinaryAdminDocRoutes = []edge.RouteSpec{
	{Method: "POST", Pattern: "/api/balancer/tournaments/{tournament_id}/teams/import", Auth: edge.AuthRequired}, // multipart
}
